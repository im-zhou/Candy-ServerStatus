		...
		for (var i = 0; i < result.servers.length; i++) {
			...
			if (!result.servers[i].online4 && !result.servers[i].online6) {
				if (server_status[i]) {
					...
					TableRow.children["cpu"].children[0].children[0].innerHTML = "<small>-</small>";
					...
					TableRow.children["memory"].children[0].children[0].innerHTML = "<small>-</small>";
					...
					TableRow.children["hdd"].children[0].children[0].innerHTML = "<small>-</small>";
				...
				// Swap
				ExpandRow[0].children["expand_swap"].innerHTML = "交换区: " + bytesToSize(result.servers[i].swap_used*1024, 2) + " / " + bytesToSize(result.servers[i].swap_total*1024, 2);
